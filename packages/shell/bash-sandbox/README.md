...
Preflight prepares confinement for the complete resolved command without launching it. The local executor rechecks any final-launch authorization after its actual confinement await.
