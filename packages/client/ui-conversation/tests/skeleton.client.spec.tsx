...
function mount(
  ...
  const props: ConversationRootProps = {
    ...
    SessionProvider: ({ children }) => children,
    useSession: options.noSession === true ? () => undefined : useSession,
    useConversation: options.noSession === true ? () => undefined : useConversation,
    ...
    useInput: options.noSession === true ? () => undefined : useInput,
    inputActions,
    renderSlot,
    renderSlotChain,
