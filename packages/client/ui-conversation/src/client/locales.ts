...
export const zh = {
  ...
  'hero.workspaceFailure': '无法打开工作区：{reason}',
  'hero.workspaceFailureUnknown': '连接失败，请重新选择工作区重试。',
...
export const en = {
  ...
  'hero.workspaceFailure': 'Could not open workspace: {reason}',
  'hero.workspaceFailureUnknown': 'Connection failed. Select the workspace again to retry.',
