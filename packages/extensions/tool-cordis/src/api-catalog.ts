...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Resolve the preset matching the effective knob values. A still-matching last selection wins shared-bundle ties. A mismatching explicit selection requires reselection; only sessions without one use the first matching configured bundle. Unmatched settings return CUSTOM_PRESET.',
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'guard(guard: ToolGuard, stage: \'prepare\' | \'dispatch\' = \'prepare\'): () => void',
        ...
        parameters: [{ name: 'guard', description: 'synchronous check; a returned string denies the execution.' }, { name: 'stage', description: 'prepare consumes approval once; dispatch rechecks revocable policy immediately before each body invocation, after all wrappers.' }],
