...
来源：[`packages/interaction/user-approval/src/types.ts:85`](../packages/interaction/user-approval/src/types.ts)
...
来源：[`packages/interaction/user-approval/src/types.ts:98`](../packages/interaction/user-approval/src/types.ts)
