...
export const en = {
  ...
  setupTitle: 'Preparing DeepSeek Harness',
  setupDescription: 'First launch installs the bundled desktop runtime. This can take several minutes on Windows while files are verified and unpacked.',
  setupVerifying: 'Verifying the bundled installation package…',
  setupStore: 'Unpacking the offline package store…',
  setupInstalling: 'Installing the desktop runtime…',
  setupHealth: 'Checking that the desktop backend can start…',
  setupActivating: 'Activating the desktop runtime…',
  setupStarting: 'Starting DeepSeek Harness…',
...
export const zh = {
  ...
  setupWindowTitle: 'DeepSeek Harness',
  setupTitle: '正在准备 DeepSeek Harness',
  setupDescription: '首次启动会安装内置的桌面运行时。在 Windows 上校验并解包文件可能需要几分钟。',
  setupVerifying: '正在校验内置安装包…',
  setupStore: '正在解包离线包存储…',
  setupInstalling: '正在安装桌面运行时…',
  setupHealth: '正在检查桌面后端能否启动…',
  setupActivating: '正在激活桌面运行时…',
  setupStarting: '正在启动 DeepSeek Harness…',
