...
export const en = {
  ...
  pluginsMenu: 'Manage Desktop Plugins',
  pluginsMenuPackagedOnly: 'Manage Desktop Plugins (available in packaged applications)',
  fileMenu: 'File',
  editMenu: 'Edit',
  windowMenu: 'Window',
  ...
  setupWindowTitle: 'DeepSeek Harness',
  setupTitle: 'DeepSeek Harness',
  setupDescription: 'From one idea, infinite possibilities.',
  setupVerifying: 'Checking your app…',
  setupStore: 'Preparing your extensions…',
  setupInstalling: 'Preparing your workspace…',
  setupHealth: 'Checking your workspace…',
  setupActivating: 'Getting things ready…',
  setupStarting: 'Opening your workspace…',
  setupReady: 'Ready to begin',
  setupProgress: 'Preparing files · {percent}%',
  setupFootnote: 'Your workspace opens as soon as it is ready.',
  setupInteraction: 'Move to explore · Click to scatter stardust',
  setupStepVerify: 'Check',
  setupStepPrepare: 'Prepare',
  setupStepOpen: 'Open',
...
export const zh = {
  ...
  pluginsMenu: '桌面插件管理',
  pluginsMenuPackagedOnly: '桌面插件管理（打包应用中可用）',
  fileMenu: '文件',
  editMenu: '编辑',
  windowMenu: '窗口',
  ...
  setupWindowTitle: 'DeepSeek Harness',
  setupTitle: 'DeepSeek Harness',
  setupDescription: '从一个想法，开始无限可能。',
  setupVerifying: '正在检查应用…',
  setupStore: '正在准备你的扩展…',
  setupInstalling: '正在准备工作空间…',
  setupHealth: '正在检查工作空间…',
  setupActivating: '准备就绪，即将开启…',
  setupStarting: '正在打开工作空间…',
  setupReady: '一切就绪',
  setupProgress: '正在准备文件 · {percent}%',
  setupFootnote: '准备完成后，自动进入工作空间。',
  setupInteraction: '移动鼠标，星尘相随 · 点击，绽放星芒',
  setupStepVerify: '检查',
  setupStepPrepare: '准备',
  setupStepOpen: '开启',
