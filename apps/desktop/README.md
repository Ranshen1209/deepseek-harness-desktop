...
Desktop enables the official experimental [Auto review](../../packages/experimental/auto-review/README.md) alongside Read only, Workspace write and Full access. New sessions default to Workspace write; selecting Auto uses the official current-session risk confirmation. Auto is not offered as a default for future sessions. The retired `@nanmicoder/dsh-auto-mode` is neither activated nor included in the application dependency tree.
