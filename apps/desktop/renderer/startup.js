...
async function main() {
  ...
  window.addEventListener('pagehide', stopParticles, { once: true })
  ...
  function render(state) {
    ...
    if (failed || state.phase === 'ready') stopParticles()
    document.querySelector('main').setAttribute('aria-busy', String(state.phase === 'starting'))
